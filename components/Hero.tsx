  ...
  return (
    ...
    >
      <div className="absolute inset-0" aria-hidden="true">
        ...
        />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, #0a0a0a, #1a1a1a)', opacity: 0.9 }} />
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse 70% 60% at 15% 50%, rgba(201,168,76,0.12) 0%, transparent 65%)' }} />
      </div>
      ...
      <div
        ...
        style={{ background: 'linear-gradient(to bottom, transparent 10%, var(--primary) 50%, transparent 90%)', opacity: 0.35 }}
        aria-hidden="true"
      />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-24">
        <div className="max-w-4xl">
          ...
          >
            Procurement,{' '}
            <em style={{ color: 'var(--primary)', fontStyle: 'italic', textShadow: '0 0 80px rgba(201,168,76,0.4)' }}>
              Compliance
            </em>{' '}
            &amp;{' '}
            <em style={{ color: 'var(--primary)', fontStyle: 'italic', textShadow: '0 0 80px rgba(201,168,76,0.4)' }}>
            ...
            <br />
            <span style={{ opacity: 0.7 }}>Experts for South Africa&apos;s Mining Sector</span>
          </h1>

          <p
            className="text-lg md:text-xl mb-10 max-w-2xl hero-anim-3"
            style={{ color: 'var(--text-on-dark-muted)', lineHeight: 1.75, fontFamily: 'var(--font-body)', fontWeight: 400 }}
          >
            Thendo Procurement delivers expert procurement spend optimisation, Mining Charter &amp; DTIC compliance, Enterprise Development and Supplier Development — backed by 13+ years of proven expertise and a collective 20+ years of industry knowledge.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4 hero-anim-4">
            ...
            <a
              ...
              onMouseEnter={e => { e.currentTarget.style.background = 'rgba(255,255,255,0.1)'; e.currentTarget.style.borderColor = 'var(--border-gold)'; }}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 hero-scroll-indicator" aria-hidden="true">
        <span className="text-[10px] tracking-[0.3em] uppercase" style={{ color: 'var(--text-on-dark-subtle)', fontFamily: 'var(--font-body)', fontWeight: 400 }}>Scroll</span>
